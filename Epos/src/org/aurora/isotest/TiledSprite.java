...
public class TiledSprite extends Sprite {
	...
	public TiledSprite(int x, int y, int w, int h, ImagesLoader imsLd,
			String name, WorldDisplay wd) {
	...
	/*
	 * Relative to this sprite's tile position, which quadrant direction is
	 * needed to get to p? p is assumed to be adjacent to this tile.
